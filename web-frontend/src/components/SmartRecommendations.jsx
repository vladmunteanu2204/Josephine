  ...
  return (
    <div className="sr-loading-screen">
      <div className="sr-loading-mark">
        <img src="/logo.webp" alt="" className="sr-loading-mark-img" onError={e => e.currentTarget.style.opacity = '0'} />
              ...
              <div className="sr-hero-card" onClick={() => viewTrail(hero)}>
                <div className="sr-hero-card__img-wrap">
                  ...
                  <span className="sr-hero-card__pick-badge">
                    <img src="/logo.webp" alt="" className="sr-pick-badge-mark" onError={e => e.currentTarget.style.display = 'none'} />
                    Josephine's Pick
                  </span>
                ...
                <div className="sr-hero-card__body">
                  ...
                  {hero.josephine_note && (
                    <div className="sr-josephine-reason">
                      <img src="/logo.webp" alt="" className="sr-reason-mark" onError={e => e.currentTarget.style.display = 'none'} />
      ...
      <div className="sr-header">
        <div className="sr-header-inner">
          <div className="sr-josephine-mark">
            <img src="/logo.webp" alt="" className="sr-mark-img" />
          </div>
          <div>
