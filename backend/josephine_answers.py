...
ANSWERS = {
    # ── Weather-gear (SAFETY) ────────────────────────────────────────────────
    'wxGearRain': {
        'en': ["Rain in the Dolomites is serious — pack a proper waterproof shell (not just water-resistant), and waterproof your boots or bring gaiters. Wet limestone is as slippery as ice, so trekking poles help a lot. Layer underneath the shell because it'll be cold too. If there's a storm risk, be off any exposed ridge or via ferrata by 13:00 — lightning up here is the main danger and it moves fast. Keep an eye on the south sky."],
        'it': ["La pioggia nelle Dolomiti è una cosa seria — porta una giacca davvero impermeabile (non solo idrorepellente) e impermeabilizza gli scarponi o porta le ghette. La roccia calcarea bagnata è scivolosa come il ghiaccio, quindi i bastoncini aiutano molto. Vesti a strati sotto la giacca, perché farà anche freddo. Se c'è rischio di temporali, scendi da creste esposte o vie ferrate entro le 13:00 — i fulmini quassù sono il pericolo principale e arrivano in fretta. Tieni d'occhio il cielo a sud."],
        'de': ["Regen in den Dolomiten ist ernst zu nehmen — pack eine richtige wasserdichte Jacke ein (nicht nur wasserabweisend) und imprägniere deine Schuhe oder nimm Gamaschen mit. Nasser Kalkfels ist so rutschig wie Eis, daher helfen Stöcke sehr. Zieh unter der Jacke Schichten an, denn es wird auch kalt. Bei Gewittergefahr sei bis 13:00 von jedem exponierten Grat oder Klettersteig herunter — Blitze sind hier oben die Hauptgefahr und ziehen schnell auf. Behalte den südlichen Himmel im Auge."],
    },
    'wxGearSun': {
        'en': ["High-altitude sun is stronger than it looks — Dolomite limestone reflects UV like a mirror. SPF 50 is not overkill, especially above 2000m. Polarised sunglasses help on the pale rock. Bring at least 2L of water (3L on a hard trail), and if it's above 25°C start early or head straight to altitude where it stays cooler. A thin packable layer still belongs in your bag — the summit will always be colder than the valley."],
        'it': ["Il sole in quota è più forte di quanto sembri — la dolomia riflette i raggi UV come uno specchio. La protezione 50 non è esagerata, soprattutto sopra i 2000 m. Gli occhiali da sole polarizzati aiutano sulla roccia chiara. Porta almeno 2L d'acqua (3L su un percorso impegnativo) e, se supera i 25°C, parti presto o sali subito in quota dove resta più fresco. Uno strato leggero e comprimibile va comunque messo nello zaino — la cima sarà sempre più fredda della valle."],
        'de': ["Die Sonne in der Höhe ist stärker, als sie aussieht — Dolomitenkalk reflektiert UV wie ein Spiegel. LSF 50 ist nicht übertrieben, vor allem über 2000 m. Polarisierte Sonnenbrillen helfen auf dem hellen Fels. Nimm mindestens 2L Wasser mit (3L auf einer schweren Tour), und bei über 25°C starte früh oder geh gleich in die Höhe, wo es kühler bleibt. Eine dünne, packbare Schicht gehört trotzdem in den Rucksack — der Gipfel ist immer kälter als das Tal."],
    },
    'wxGearWind': {
        'en': ["Wind on the Dolomite ridges can be sudden and strong. A windproof outer shell — even a lightweight running jacket — makes a huge difference. Secure your hat, and if gusts are above 40 km/h I'd avoid narrow exposed ridges and via ferratas. You'll feel the wind chill mainly on the return, so keep a layer accessible."],
        'it': ["Il vento sulle creste delle Dolomiti può essere improvviso e forte. Una giacca antivento — anche una leggera da running — fa una grande differenza. Fissa bene il cappello e, se le raffiche superano i 40 km/h, eviterei creste strette ed esposte e le vie ferrate. Sentirai il freddo del vento soprattutto al ritorno, quindi tieni uno strato a portata di mano."],
        'de': ["Wind auf den Dolomitengraten kann plötzlich und stark sein. Eine winddichte Außenjacke — selbst eine leichte Laufjacke — macht einen riesigen Unterschied. Sichere deine Mütze, und bei Böen über 40 km/h würde ich schmale, exponierte Grate und Klettersteige meiden. Die Windkälte spürst du vor allem am Rückweg, halte also eine Schicht griffbereit."],
    },
    'wxGearFog': {
    ...
    'gearHard': {
        'en': ["For hard or alpine routes, stiff mountain boots are non-negotiable — Dolomite scree will destroy trail runners. Carry 3L of water, a full rain layer, first-aid kit, an emergency thermal blanket, and download the GPS track before leaving (no signal above 1600m usually). Via ferrata routes also need a harness and lanyard."],
        'it': ["Per percorsi impegnativi o alpini, gli scarponi rigidi da montagna sono irrinunciabili — i ghiaioni dolomitici distruggono le trail runner. Porta 3L d'acqua, una giacca antipioggia completa, un kit di primo soccorso, una coperta termica d'emergenza, e scarica la traccia GPS prima di partire (di solito niente segnale sopra i 1600 m). Le vie ferrate richiedono anche imbrago e set da ferrata."],
        'de': ["Für schwere oder alpine Touren sind steife Bergstiefel Pflicht — Dolomitenschotter zerstört Trailrunner. Nimm 3L Wasser, eine vollwertige Regenschicht, ein Erste-Hilfe-Set, eine Rettungsdecke mit und lade den GPS-Track vor dem Start herunter (über 1600 m meist kein Empfang). Klettersteige brauchen zusätzlich Gurt und Klettersteigset."],
    },
    'gearMedium': {
        'en': [
            "For a medium hike the most important thing is hiking boots with ankle support — Dolomite scree demands it. Pack 2L of water, a rain layer (afternoon thunderstorms are common June–August, aim to be below the treeline by 1pm), a snack, and sunscreen. Trekking poles help significantly on the descent. Temperatures drop roughly 6°C per 1000m, so always bring a layer even on a warm valley day.",
    ...
    'startTime': {
        'en': [
            ...
            "Early. Always earlier than feels necessary. The classic Dolomite pattern is clear mornings and building cloud after lunch, with storms possible by mid-afternoon, so aim to summit or turn around by around midday. An 7–8am start also means parking is still free and the rifugio terraces aren't packed yet.",
        ],
        'it': [
